...
function App() {
  ...
  const [, setRejected] = useState(false);
  ...
  const slowQueries =
    investigation?.evidence?.slow_queries || [];

  const deployments =
    investigation?.evidence?.deployments || [];
        ...
        <section className="hero">
          <div>
            ...
            <p className="hero-text">
              InfraPilot correlates application, database and
              deployment signals to identify the most probable cause.
            </p>
          </div>
          ...
          <div className="panel">
            ...
            {reviewOpen && (
              <div className="review-panel">
                ...
                <p>
                  Please review the recommended action
                  before approving it.
                </p>
            ...
            {auditLogs.map((log) => (
              ...
              >
                ...
                <div>
                  ...
                  <p>
                    {log.action === "REJECTED"
                      ? `Rejection recorded at ${new Date(
                          log.created_at
                        ).toLocaleString()}`
                      : `Approval recorded at ${new Date(
                          log.created_at
                        ).toLocaleString()}`}
                  </p>
        ...
        <section className="section">
          ...
          <div className="metrics-grid">
            ...
            <div className="metric-card">
              ...
              <strong>
                {investigation?.evidence?.query_plan?.length || 0}
                {" "}
                lines
              </strong>
            </div>
